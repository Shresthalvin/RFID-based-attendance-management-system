...
const char *ssid = "Jinchūriki";  //ENTER YOUR WIFI SETTINGS
const char *password = "123@ssid";
...
void setup() {
  ...
  wifiManager.autoConnect("Jinchūriki","123@ssid");
...
void loop() {
 ...
 for (byte i = 0; i < mfrc522.uid.size; i++) {
  ...
  //GET Data
  getData = CardID;
  Link = "http://92.168.0.102:8000/admin/attendance/student/="+ getData; // ENTER YOUR HOST NAME HERE
  Serial.print(Link);
